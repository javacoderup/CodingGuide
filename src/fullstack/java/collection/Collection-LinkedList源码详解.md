...
-   [LinkedList源码解析](#collection---linkedlist%E6%BA%90%E7%A0%81%E8%A7%A3%E6%9E%90)
    -   [概述](#%E6%A6%82%E8%BF%B0)
    -   [LinkedList实现](#LinkedList%E5%AE%9E%E7%8E%B0)
        ...
        -   [addAll()](#addall)
        -   [clear()](#clear)
        -   [Positional Access 方法](#positional-access-%E6%96%B9%E6%B3%95)
        -   [查找操作](#%E6%9F%A5%E6%89%BE%E6%93%8D%E4%BD%9C)
        -   [Queue 方法](#queue-%E6%96%B9%E6%B3%95)
        -   [Deque 方法](#deque-%E6%96%B9%E6%B3%95)
...
![LinkedList底层实现](/assets/images/java/LinkedList_base.png)
...
LinkedList底层**通过双向链表实现**，本节将着重讲解插入和删除元素时双向链表的维护过程，也即是之间解跟List接口相关的函数，而将Queue和Stack以及Deque相关的知识放在下一节讲。双向链表的每个节点用内部类Node表示。LinkedList通过`first`和`last`引用分别指向链表的第一个和最后一个元素。注意这里没有所谓的哑元，当链表为空的时候`first`和`last`都指向`null`。
...
![LinkedList删除元素实现.png](/assets/images/java/LinkedList_remove.png)
...
![LinkedList底层添加实现](/asstes/images/java/LinkedList_add.png)
